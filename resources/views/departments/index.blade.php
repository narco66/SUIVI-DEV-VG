            ...
            <div class="h-100 rounded-4 border bg-primary bg-opacity-10 p-4 shadow-sm">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        ...
                        <h2 class="h3 fw-bold text-dark mb-1">Départements Internes</h2>
                        <p class="text-muted mb-2">Organisez la structure interne par départements, institutions de rattachement et responsables.</p>
                        <span class="badge bg-white text-primary border fw-semibold px-3 py-2">
                            {{ $departments->total() }} département(s) configuré(s)
                        </span>
                    </div>
                </div>
            </div>
