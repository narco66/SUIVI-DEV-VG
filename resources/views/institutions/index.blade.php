            ...
            <div class="h-100 rounded-4 border bg-primary bg-opacity-10 p-4 shadow-sm">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        ...
                        <h2 class="h3 fw-bold text-dark mb-1">Institutions</h2>
                        <p class="text-muted mb-2">Gérez les organes communautaires, institutions des États membres et partenaires.</p>
                        <span class="badge bg-white text-primary border fw-semibold px-3 py-2">
                            {{ $institutions->total() }} institution(s) configurée(s)
                        </span>
                    </div>
                </div>
            </div>
